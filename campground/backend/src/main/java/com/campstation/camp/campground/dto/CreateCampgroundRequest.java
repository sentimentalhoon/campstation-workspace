...
public record CreateCampgroundRequest(
    ...
    @Schema(description = "운영 주체", example = "DIRECT", allowableValues = {"DIRECT", "PARTNER", "PRIVATE", "FRANCHISE"})
    CampgroundOperationType operationType,

    @Schema(description = "인증/등급", example = "PREMIUM", allowableValues = {"PREMIUM", "CERTIFIED", "STANDARD", "NEW"})
